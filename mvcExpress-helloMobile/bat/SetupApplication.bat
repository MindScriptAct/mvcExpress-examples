...
:: Android packaging
set AND_CERT_NAME="mobileTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\mobileTest.p12
...
set IOS_PROVISION=cert\mobileTest.mobileprovision
...
set APP_ID=air.mobileTest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=mobileTest
