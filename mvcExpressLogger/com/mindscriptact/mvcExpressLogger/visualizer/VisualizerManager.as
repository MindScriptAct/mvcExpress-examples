	...
	public function logMvcExpress(logObj:Object):void {
		...
		switch (logObj.action) {
			case "MediatorMap.mediate"://MvcTraceActions.MEDIATORMAP_MEDIATE:
				...
				//mediatorClass = modularProject.mvcExpressVisualizer.view.VisualLoggerTestModuleMediator$)
				//viewClass = modularProject.mvcExpressVisualizer.VisualLoggerTestModule$)
				//viewObject = modularProject.mvcExpressVisualizer.VisualLoggerTestModule (@5845f91)
